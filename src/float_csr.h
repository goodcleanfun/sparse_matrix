...
#define SPARSE_TYPE_NAME float_csr_matrix
...
static inline bool float_csr_matrix_log(float_csr_matrix *self) {
    float_array_log(self->data);
    return true;
}

static inline bool float_csr_matrix_exp(float_csr_matrix *self) {
