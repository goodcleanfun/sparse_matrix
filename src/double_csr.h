...
COMPRESSED_SPARSE_MATRIX_INIT(double_csr, double, double_array, row)
CSR_DOT_SPARSE(double_csr, double, uint32_t, uint32_array, row, uint32_double, uint32_minheap)
